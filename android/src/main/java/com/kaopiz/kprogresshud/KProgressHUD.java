...
public class KProgressHUD {
    ...
    public KProgressHUD(Context context) {
        ...
        mWindowColor = context.getResources().getColor(com.svprogressbridger.R.color.kprogresshud_default_color);
        mAnimateSpeed = 1;
        mCornerRadius = 10;
        mIsAutoDismiss = true;
        mGraceTimeMs = 0;
   ...
   */
    ...
    private class ProgressDialog extends Dialog {
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            setContentView(com.svprogressbridger.R.layout.kprogresshud_hud);
        ...
        private void initViews() {
            mBackgroundLayout = (BackgroundLayout) findViewById(com.svprogressbridger.R.id.background);
            ...
            mCustomViewContainer = (FrameLayout) findViewById(com.svprogressbridger.R.id.container);
            ...
            mLabelText = (TextView) findViewById(com.svprogressbridger.R.id.label);
            setLabel(mLabel, mLabelColor);
            mDetailsText = (TextView) findViewById(com.svprogressbridger.R.id.details_label);
